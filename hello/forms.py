...
class GradeForm(forms.Form):
    ...
    lo_list = forms.CharField(label='LO list', max_length=500,label_suffix="")
    co_list = forms.CharField(label='CO list', max_length=500, label_suffix="")
    assignment_title = forms.CharField(label='Assignment titles', max_length=500, label_suffix="")
    assignment_weight = forms.CharField(label='Assignment weights', max_length=500, label_suffix="")
    default_lo = forms.CharField(label='LO to highlight in LO evolution graph', max_length=500, label_suffix="")
