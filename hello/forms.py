...
class GradeForm(forms.Form):
    ...
    default_lo = forms.CharField(label='LO to highlight in LO evolution graph (Optional)', max_length=500, label_suffix="",  required=False, widget=forms.Textarea(attrs={'rows':4, 'cols':15}))
